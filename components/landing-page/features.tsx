		...
		<section className="container-6xl my-12">
			...
			<ul className="grid grid-cols-1 gap-8 py-10 md:grid-cols-2 md:gap-6">
				{features.map((feature) => (
					...
					>
						<li className="hover:-translate-y-1 relative z-1 flex flex-col items-center space-y-2 rounded-md bg-background p-4 shadow-lg transition-all duration-300 ease-in hover:shadow-xl">
							<motion.div
