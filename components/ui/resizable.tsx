...
function ResizablePanelGroup({
	...
	return (
		<ResizablePrimitive.PanelGroup
			className={cn("flex min-h-full w-full flex-row md:flex-col", className)}
...
function ResizableHandle({
	...
	return (
		...
		>
			{withHandle && (
				<div className="z-10 flex h-4 w-3 items-center justify-center rounded-xs border border-muted bg-border">
