...
export default function Home() {
  return (
    <>
      {/* hero */}
      <div className="container-6xl mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <div className="relative isolate">
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-30 bg-gradient-to-tr from-pink-600 to-violet-600 opacity-50 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            />
          </div>
          <div>
